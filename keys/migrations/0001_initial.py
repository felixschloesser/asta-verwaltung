# Generated by Django 3.1.5 on 2021-02-11 13:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', models.CharField(max_length=8, unique=True, verbose_name='Gebäudekürzel')),
            ...
            managers=[
                ('all_buildings', django.db.models.manager.Manager()),
            ],
        ),
        migrations.CreateModel(
            name='Deposit',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('access', 'Zugangstür'), ('connecting', 'Verbindungstür')], default=('access', 'Zugangstüre'), max_length=32, verbose_name='Typ')),
                ('comment', models.CharField(blank=True, max_length=500, null=True, verbose_name='Kommentar')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Erstellungszeitpunkt')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Aktualisierungszeitpunkt')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.CharField(help_text='Ohne Gebäudekürzel: E0.069 -> 0.069', max_length=32, verbose_name='Raumnummer')),
                ('name', models.CharField(blank=True, max_length=32, null=True, unique=True, verbose_name='Raumname')),
                ('comment', models.CharField(blank=True, max_length=500, null=True, verbose_name='Kommentar')),
                ('slug', autoslug.fields.AutoSlugField(editable=False, populate_from=keys.models.get_room_slug, unique=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Erstellungszeitpunkt')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Aktualisierungszeitpunkt')),
                ...
                ('purpose', models.ForeignKey(blank=True, help_text='Für FSRe&AStA wird automatisch ein Name aus Gruppe und Zweck generiert. "FSR VT" + "Lager" -> "FSR VT LAGER"', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='rooms', to='keys.purpose', verbose_name='Zweck')),
            ],
            options={
                'verbose_name': 'Raum',
            ...
            managers=[
                ('all_rooms', django.db.models.manager.Manager()),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='issue',
            name='person',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='issues', to='keys.person', verbose_name='Person'),
        ),
        migrations.AddField(
            model_name='door',
            name='locking_system',
