    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issues', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='person', to='keys.Issue', verbose_name='Ausgaben')),
            ],
            options={
                'verbose_name': 'Person',
        ...
        migrations.AddConstraint(
            model_name='issue',
            constraint=models.UniqueConstraint(fields=('keys',), name='person+key_is_unique'),
        ),
        migrations.AddConstraint(
            model_name='issue',
