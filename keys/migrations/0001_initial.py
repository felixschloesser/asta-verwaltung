    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(blank=True, max_length=500, null=True, verbose_name='Kommentar')),
                ('slug', autoslug.fields.AutoSlugField(editable=False, populate_from=keys.models.get_populate_from, unique=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Erstellungszeitpunkt')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Aktualisierungszeitpunkt')),
        ...
        migrations.AddConstraint(
            model_name='deposit',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('out_datetime__isnull', True), ('out_method__isnull', True), ('state', 'in')), models.Q(('out_datetime__isnull', True), ('out_method__isnull', True), ('state', 'retained')), models.Q(('out_datetime__isnull', False), ('out_method__isnull', False), ('state', 'out')), _connector='OR'), name='in_deposit_no_out_datetime_out_method'),
        ),
        migrations.AddConstraint(
            model_name='deposit',
