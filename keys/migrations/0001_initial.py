    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('out_date', models.DateField(default=datetime.datetime(2020, 7, 2, 15, 18, 5, 479228, tzinfo=utc), verbose_name='Ausgabedatum')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deposit', models.DecimalField(decimal_places=2, default=50.0, max_digits=8, verbose_name='Kaution')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Erstellungszeitpunkt')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Aktualisierungszeitpunkt')),
